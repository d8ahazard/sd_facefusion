...
background_remover_model: Optional[str] = 'modnet'
background_remover_fill_color: tuple = (0, 0, 0, 0)
background_remover_despill_color: tuple = (0, 0, 0, 0)
...
face_detector_model: Optional[FaceDetectorModel] = 'yolo_face'
face_occluder_model: Optional[str] = 'xseg_3'
...
execution_device_ids: Optional[List[int]] = [0]
custom_yolo_model: Optional[str] = None
custom_yolo_confidence: Optional[float] = 0.5
custom_yolo_radius: Optional[int] = 10
auto_padding_model: Optional[str] = 'None'
auto_padding_confidence: Optional[float] = 0.5
auto_padding_intersection_threshold: Optional[int] = 50
auto_padding_mask_areas: Optional[List[str]] = ['upper-face', 'lower-face', 'mouth']
# frame extraction
...
output_image_scale: Optional[float] = 1.0
output_video_scale: Optional[float] = 1.0
download_scope: Optional[str] = 'lite'
...
mapping_slot_keys: Optional[list] = []
