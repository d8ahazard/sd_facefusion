...
WORDING: Dict[str, Any] = \
    {
        ...
        'help.face_enhancer_smart_enhance': 'enable smart enhance that only processes faces meeting minimum size criteria',
        'help.face_enhancer_smart_minimum_size': 'specify the minimum face height in pixels for smart enhance',
        ...
        'help': {
            ...
            'deep_swapper_model': 'choose the model responsible for deep swapping the face',
            'deep_swapper_morph': 'specify the morph strength applied during deep swapping',
            'background_remover_model': 'choose the model responsible for removing the background',
            'background_remover_fill_color': 'apply red, green, blue and alpha values to the background',
            'background_remover_despill_color': 'remove red, green, blue and alpha values from the foreground',
            ...
            'style_changer_target': 'choose whether to apply the style to the source images, target media, or the head of the source and the bg of the target',
            'style_changer_skip_head': 'skip the head of the target when processing style changer',
            'style_transfer_model': 'choose the model responsible for transferring the style',
        ...
        'uis': {
            ...
            'face_enhancer_smart_enhance_checkbox': 'ENABLE SMART ENHANCE',
            'face_enhancer_smart_minimum_size_slider': 'SMART ENHANCE MINIMUM SIZE',
            ...
            'background_remover_fill_color_red_number': 'FILL COLOR RED',
            'background_remover_fill_color_green_number': 'FILL COLOR GREEN',
            'background_remover_fill_color_blue_number': 'FILL COLOR BLUE',
            'background_remover_fill_color_alpha_number': 'FILL COLOR ALPHA',
            'background_remover_despill_color_red_number': 'DESPILL COLOR RED',
            'background_remover_despill_color_green_number': 'DESPILL COLOR GREEN',
            'background_remover_despill_color_blue_number': 'DESPILL COLOR BLUE',
            'background_remover_despill_color_alpha_number': 'DESPILL COLOR ALPHA',
            ...
            'style_target_image': 'STYLE IMAGE',
